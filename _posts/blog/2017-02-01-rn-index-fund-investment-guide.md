...
- 5）查询：[东方财富网](http://quote.eastmoney.com/center/index.html#zyzs_0_1)(http://quote.eastmoney.com/center/index.html#zyzs_0_1)
...
![image](../../images/rn-index-fund-investment-guide/search-index.png)

点击指数代码我们可以进到指数详细信息介绍的页面，这里有指数的详细信息。

![image](../../images/rn-index-fund-investment-guide/index-info.png)
...
- 1、初始投资时刻的股息率。
	- 这个数据很容易获得，买入指数基金时就可以确定。一般指数基金越低估，股息率越高。
- 2、投资期内的市盈率变化。
	- 买入时的市盈率在买入时就确定了，但未来市盈率如何变化是难以预测的。
	- 从长期来看，市盈率会在一个范围内呈周期性变化。所以我们可以统计指数历史市盈率的波动范围，确定当前市盈率处于历史波动范围的哪一个位置，从而评估当前市盈率是低估、正常，还是高估。选择在低估的时候买入，在高估的时候卖出。
- 3、投资期内的盈利增长率。
	- 对指数基金来说，一般只要国家经济长期发展取得增长，盈利就会上涨。
	- 盈利的增速我们是难以预测的。
...
对于定投年化收益率的计算，可以使用 Excel 的 IRR 算法，可以参考：[定投的收益率该怎么算？][3]。
