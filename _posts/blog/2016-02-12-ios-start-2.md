---
layout: post
title: iOS 入门：上手(Objective-C)
description: iOS 入门教程：本文的内容主要是让大家能够快速上手一个 iOS 项目，对 iOS 开发有一个初步概念。
category: blog
tag: iOS, start, tutorial, Objective-C
---

本文的内容主要是让大家能够快速上手一个 iOS 项目，对 iOS 开发有一个初步概念。

目录：

- 1、一个多页面 App 项目的架构
	- 1.1、项目目录结构调整
	- 1.2、Tab 式 + Navigation 式的项目架构实现
	- 1.3、使用 UITableView
